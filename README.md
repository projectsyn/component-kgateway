# Commodore Component: kgateway

This is a [Commodore][commodore] Component for kgateway.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/kgateway).
